...
const VIDEOS = [
  { id: 1, title: 'فعاليات اليوم المفتوح 2025', url: 'https://www.youtube.com/watch?v=ScMzIvxBSi4', category: 'فعاليات', desc: 'جولة شاملة في فعاليات يوم التعريف الخاص بالمدرسة' },
  { id: 2, title: 'مسابقة الروبوت التعليمية', url: 'https://www.youtube.com/watch?v=LXb3EKWsInQ', category: 'مسابقات', desc: 'تغطية مشاركة فريق الروبوت في المسابقة الوطنية' },
  { id: 3, title: 'حفل تكريم المتفوقين', url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', category: 'حفلات', desc: 'حفل تكريم الطلاب المتميزين أكاديمياً للعام الدراسي' },
  { id: 4, title: 'بطولة كرة القدم الداخلية', url: 'https://www.youtube.com/watch?v=BQ0mxQXmLsk', category: 'رياضة', desc: 'أبرز لحظات بطولة كرة القدم بين فصول المدرسة' },
  { id: 5, title: 'المعرض العلمي السنوي', url: 'https://www.youtube.com/watch?v=9bZkp7q19f0', category: 'علمي', desc: 'مشاريع الطلاب في المعرض العلمي السنوي 2025' },
  { id: 6, title: 'رحلة وادي شاب', url: 'https://www.youtube.com/watch?v=ZbZSe6N_BXs', category: 'رحلات', desc: 'الرحلة الميدانية لطلاب الصف الثامن إلى وادي شاب' },
  { id: 7, title: 'عرض المسرحية السنوية', url: 'https://www.youtube.com/watch?v=fJ9rUzIMcZQ', category: 'فنون', desc: 'المسرحية السنوية لفريق التمثيل المدرسي' },
  { id: 8, title: 'كلمة مدير المدرسة', url: 'https://www.youtube.com/watch?v=iik25wqIuFo', category: 'رسمي', desc: 'كلمة مدير المدرسة في بداية العام الدراسي الجديد' },
  { id: 9, title: 'تغطية يوم القراءة', url: 'https://www.youtube.com/watch?v=6g4dkBF5anU', category: 'فعاليات', desc: 'تغطية أنشطة وفعاليات يوم القراءة العُماني' },
]
...
export default function VideosPage() {
  ...
  const categories = useMemo(() => ['all', ...new Set(VIDEOS.map(v => v.category).filter(Boolean))], [])
  const filtered = filter === 'all' ? VIDEOS : VIDEOS.filter(v => v.category === filter)
  const playingVideo = playing !== null ? VIDEOS.find(v => v.id === playing) : null
